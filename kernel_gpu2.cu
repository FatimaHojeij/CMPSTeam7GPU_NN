...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	for (unsigned int layer = 0; layer < numLayers; ++layer) {
		...
		dim3 numBlocks3((W_d[layer].numCols + numThreadsPerBlock3.x*COARSE_FACTOR - 1) / (numThreadsPerBlock3.x*COARSE_FACTOR), (inBuffer_d.numRows + numThreadsPerBlock3.y*COARSE_FACTOR - 1) /( numThreadsPerBlock3.y*COARSE_FACTOR));
